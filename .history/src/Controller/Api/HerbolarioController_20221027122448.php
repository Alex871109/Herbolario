...
class HerbolarioController extends AbstractController
{
    ...
    public function edit_get(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository)
    {
        ...
        if($request->getMethod()==='POST'){
            ...
            $manager->save($data_received,$herbolario);
            die()
        }
