...
class HerbolarioController extends AbstractController
{
    ...
    public function elimeditinar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
