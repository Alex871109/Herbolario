...
class HerbolarioController extends AbstractController
{
    ...
    public function editar_eliminar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
        
        if(!$herbolarioRepository->findById($id))
