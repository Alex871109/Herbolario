...
class HerbolarioController extends AbstractController
{
    ...
    public function edit_get(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): response
    {
