...
class HerbolarioController extends AbstractController
{
    ...
    public function editar_(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
