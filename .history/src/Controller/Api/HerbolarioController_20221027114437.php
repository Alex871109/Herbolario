...
class HerbolarioController extends AbstractController
{
    ...
    public function elimieditar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
