...
class HerbolarioController extends AbstractController
{
    ...
    public function elimeditar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
