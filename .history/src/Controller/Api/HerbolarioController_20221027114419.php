...
class HerbolarioController extends AbstractController
{
    ...
    public function elimeditarinar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
