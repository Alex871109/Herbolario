...
class HerbolarioController extends AbstractController
{
    ...
    public function edit_get(int $id,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
        $data_received=$request->get('nombre');
        dump($data_received);
        die();
