...
class HerbolarioController extends AbstractController
{
    ...
    public function edit(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
