...
class HerbolarioController extends AbstractController
{
    ...
    public function eliminar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
        
        if(!$herbolarioRepository->getById($id,$herbolarioRepository))
