...
class HerbolarioController extends AbstractController
{
    ...
    public function elimeditainar(int $id,Request $request,EntityManagerInterface $entityManager, Manager $manager, HerbolarioRepository $herbolarioRepository): JsonResponse
    {
