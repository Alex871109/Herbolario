...
class HerbolarioController extends AbstractController
{
    ...
    //     }
        ...
        return $this->json($manager->object_to_array($herbolario)
        
    }

    #[Route('/delete/{id}', name: 'api_herbolario_delete', methods: ['DELETE'])]
    public function delete(HerbolarioRepository $herbolarioRepository, Manager $manager): JsonResponse
    {
