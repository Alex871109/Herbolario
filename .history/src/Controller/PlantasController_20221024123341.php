...
class PlantasController extends AbstractController
{
    ...
    public function nueva(Request $request,UsosRepository $usosRepository,HerbolarioRepository $herbolarioRepository,Planta EntityManagerInterface $entityManager): Response
    {
        $planta=new Planta();
