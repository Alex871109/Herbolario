...
class PlantasController extends AbstractController
{
    ...
    public function nueva(Request $request,UsosRepository $usosRepository,HerbolarioRepository $herbolarioRepository,PlantaRepository $planta EntityManagerInterface $entityManager): Response
    {
        $planta=new Planta();
