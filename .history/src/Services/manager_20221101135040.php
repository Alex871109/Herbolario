            ...
            if('Id'!==$attr){           //El Id nunca debe modificarse
                ...
                elseif(method_exists($entity,$addmethod)){
                     ...
                     foreach($value as $element){               //Aqui Value es el array de objetos usos
                        ...
                        $repository=$this->entityManager->getRepository($clase);  //repositorio de la entity en value, en este caso  UsosReposi
                        $obj=$repository->findOneById($id);
                        
                        dump($obj);
                    die;
                        // $obj=$this->array_to_object($element,'form_planta',$entity);
                        // dump($obj_array);die;
