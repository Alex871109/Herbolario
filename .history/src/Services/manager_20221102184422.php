...
Class Manager
{
    ...
    private $infocomercial;
    private $herbolarioRepository;

    public function __construct(EntityManagerInterface $entityManager,Infocomercial $infocomercial,HerbolarioRepository $herbolariorepository)
    {
        $this->entityManager=$entityManager;
        $this->infocomercial=$infocomercial;
        $this->herbolarioRepository=$herbolariorepository;
            ...
            if('Herbolario'!==$attr){           //Herbolario como parte de planta se edita diferente
                ...
                elseif(method_exists($entity,$addmethod)){ 
                    ...
                    foreach($value as $element){               //Aqui Value es el array de objetos usos
                        ...
                        $obj=$repository->findOneByNombre($nombre);
                             //Aqui tengo el objeto Uso especifico 
