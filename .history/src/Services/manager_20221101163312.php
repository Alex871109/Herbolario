        ...
        foreach($data as $key=>$value){
            ...
            if('Id'!==$attr){           //El Id nunca debe modificarse
                ...
                elseif(method_exists($entity,$addmethod)){ 
                    ...
                    $getmethod='get'.$attr;
                    $attr_collection=($entity->$getmethod($attr));die;
                    $entity->$removemethod($entity->$getmethod($attr)); //Elimino los usos en esa planta
                     ...
                     foreach($value as $element){               //Aqui Value es el array de objetos usos
                        ...
                        $obj=$repository->findOneById($id); //Aqui tengo el objeto Uso especifico 
